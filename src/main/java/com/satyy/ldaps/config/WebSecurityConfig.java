package com.satyy.ldaps.config;

import com.satyy.ldaps.trustsore.CustomDomainSSLSocketFactory;
import com.satyy.ldaps.trustsore.SslSocketFactorySimpleDirContextAuthenticationStrategy;
import com.satyy.ldaps.trustsore.SslSocketFactoryContextSource;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public DefaultSpringSecurityContextSource contextSource() {
        SslSocketFactorySimpleDirContextAuthenticationStrategy authenticationStrategy = new SslSocketFactorySimpleDirContextAuthenticationStrategy(CustomDomainSSLSocketFactory.class);
        DefaultSpringSecurityContextSource contextSource = new SslSocketFactoryContextSource(ldapConnectionUrl);
